...
: Node("trunk_detector_node", options), cloud_(new pcl::PointCloud<PointT>)
{
  ...
  sub_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
    ...
    std::bind(&TrunkDetector::pointCloudCallback, this, std::placeholders::_1));

  pub_ = this->create_publisher<trunk_detector_msgs::msg::TrunkPoseArray>(output_topic, 10);
}

TrunkDetector::~TrunkDetector() {}

void TrunkDetector::pointCloudCallback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
{
