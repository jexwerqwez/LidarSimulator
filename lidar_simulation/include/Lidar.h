...
class Lidar {
 public:
  Lidar(rclcpp::Node* node, const std::string& name,
  ...
  // возвращаем пару: <идеальное облако, зашумленное облако>
  ...
  /// публикуем только TF-позу лидара
  void publishTransform();

  std::string getFrameId() const { return frame_id_; }

  /// устанавливаем глобальную позицию лидара
