...
// Расчёт в 2D по XY-плоскости (Z — вертикальная ось)
Eigen::Vector3d oc = ray_origin - base_center;
double a = ray_direction.x() * ray_direction.x() + ray_direction.y() * ray_direction.y();
...
// Проверка, лежит ли точка пересечения в пределах высоты цилиндра
